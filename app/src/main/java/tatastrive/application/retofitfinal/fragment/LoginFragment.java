package tatastrive.application.retofitfinal.fragment;
...
import tatastrive.application.retofitfinal.MainActivity;
import tatastrive.application.retofitfinal.R;
...
public class LoginFragment extends Fragment {
    ...
    private void loginUser() {
        ...
        if (TextUtils.isEmpty(Email)){
            ...
            //only use email & password  using service interface
            Call<User> userCall = MainActivity.service_api.doLogin(Email, Password);
